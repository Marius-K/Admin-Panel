    ...
    data() {
        return {
            ...
            table: {
                data: [],
                fields: [
                { key: 'logo', class: 'text-center', class: 'text-center align-middle' },
                { key: 'name', sortable: true, sortDirection: 'asc', thClass: 'text-center', class: 'align-middle' },
                { key: 'email', sortable: true, thClass: 'text-center', class: 'align-middle' },
                { key: 'website', sortable: true, thClass: 'text-center', class: 'align-middle' },
    ...
    created() {
        axios.get('/modal/translate/main')
            .then(response => {
                ...
                Object.keys(this.translate.companies.fields).map((key, index) => {
                    this.table.fields[index].label = this.translate.companies.fields[key];
                });
            })
